...
class App extends React.Component {
  constructor(props) {
    super(props);
    _defineProperty(this, "inputNumber", (number) => {
    ...
    this.state = { currentValue: "0", upperValue: "", accValue: "" };
  ...
  render() {
    ...
    return /*#__PURE__*/ React.createElement(
      "div",
      { className: "calculator" } /*#__PURE__*/,
      React.createElement(
        "div",
        { className: "calc-display", id: "main-display" } /*#__PURE__*/,
        React.createElement(
          "div",
          { className: "upper-display" },
          accValue
        ) /*#__PURE__*/,
        React.createElement(
          "div",
...
class Keypad extends React.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/ React.createElement(
      "div",
      { className: "button", type: "button", id: ident, onClick: handleClick },
      content
    );
  }
}
